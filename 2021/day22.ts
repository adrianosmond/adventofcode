...
type Cuboid = [Coords, Coords, Coords];
const cuboids: [string, Cuboid][] = input.split('\n').map((r) => {
...
const getVolume = ([[xMin, xMax], [yMin, yMax], [zMin, zMax]]: Cuboid) =>
...
const get3DOverlap = (
  ...
  [[xMin2, xMax2], [yMin2, yMax2], [zMin2, zMax2]]: Cuboid,
): 0 | Cuboid => {
...
const getTotalNegatedByFutureCuboids = (
  cuboid: Cuboid,
  futureCuboids: Cuboid[],
) => {
